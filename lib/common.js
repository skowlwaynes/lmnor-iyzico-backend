...
const BUILT_IN_ALLOWED_ORIGINS = [
  "https://lmnorofficial.com",
  "https://www.lmnorofficial.com",
  "https://lmnor.framer.media",
];
...
function allowedOrigins() {
  const environmentOrigins = (process.env.ALLOWED_ORIGINS || "")
    .split(",")
    .map(normalizeOrigin)
    .filter(Boolean);

  return new Set([
    ...BUILT_IN_ALLOWED_ORIGINS.map(normalizeOrigin),
    ...environmentOrigins,
  ]);
}
